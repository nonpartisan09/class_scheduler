...
class NewAvailability extends Component {
  constructor(props, context) {
    ...
    const days =
      props.location && props.location.state && props.location.state.days;
        ...
        <div className="availabilityContainer">
          ...
          <form className="newAvailabilityFormContainer">
            <div>
              ...
              <a
                href={formatLink("/my_profile", currentUser.locale)}
                className="slidingLink"
              >
                <FormattedMessage
          ...
          >
            {_.map(days, (value, index) => (
              <MenuItem
                ...
                insetChildren
                checked={
                  availabilities[index] && availabilities[index].day === value
                }
                value={index}
