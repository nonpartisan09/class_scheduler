        ...
        <Router>
          <Switch>
            ...
            <Route
              exact
              path={`/${locale}/inbox`}
              render={props => <ConversationIndexPage {...data} {...props} />}
            />
            <Route
              exact
              path={`/${locale}/inbox/:id`}
              render={props => <ConversationPage {...data} {...props} />}
            />
            <Route
              exact
              path={`/${locale}/messages/new`}
              render={props => <NewMessagePage {...data} {...props} />}
            />
            <Route
              exact
              path={`/${locale}/search`}
              render={props => <SearchBar {...data} {...props} />}
            />
            <Route
              exact
              path={`/${locale}/volunteers`}
              render={props => <SearchResults {...data} {...props} />}
            />
            <Route
              exact
              path={`/${locale}/my_profile`}
              render={props => <MyProfile {...data} {...props} />}
            />
            <Route
              exact
              path={`/${locale}/:user_id/(:order)`}
              render={props => <UserReviewIndexPage {...data} {...props} />}
            />
            <Route
              exact
              path={`/${locale}/reviews/author/:url_slug`}
              render={props => <UserReviewIndexPage {...data} {...props} />}
            />
            ...
            <Route
              exact
              path={`/${locale}/password/new`}
              component={NewPasswordPage}
            />
            <Route
              exact
              path={`/${locale}/password/edit`}
              render={props => <ResetPasswordPage {...props} />}
            />
            <Route
              exact
              path={`/${locale}/availabilities/new`}
              render={props => <NewAvailability {...data} {...props} />}
            />
            <Route
              exact
            ...
            <Route
              exact
              path={`/${locale}/about`}
              render={props => <CustomPage {...data} {...props} />}
            />
            <Route
              exact
              path={`/${locale}/faq`}
            ...
            <Route
              exact
              path={`/${locale}/sign_up/:role`}
              render={props => <SignUp {...data} {...props} />}
            />
            <Route
              exact
              path={`/${locale}/volunteer_sign_up_completed`}
              render={props => <CustomPage {...data} {...props} />}
            />
            <Route
              exact
              path={`/${locale}/terms_of_use`}
              render={props => <TermsAndConditions {...data} {...props} />}
            />
            ...
            <Route
              exact
              path="/availabilities"
              render={props => <AvailabilityIndexPage {...data} {...props} />}
            />
            ...
            <Route
              exact
              path="/volunteer_sign_up_completed"
              render={props => <CustomPage {...data} {...props} />}
            />
            <Route
              exact
